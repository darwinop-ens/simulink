...
lang = add_translation2(lang,'clockwise_compliance_margin','Marge horaire','Marge angulaire dans le sens horaire');
lang = add_translation2(lang,'counterclockwise_compliance_margin','Marge anti-horaire','Marge angulaire dans le sens anti-horaire');
lang = add_translation2(lang,'clockwise_compliance_slope','Correction horaire','Intervalle de correction dans le sens horaire');
lang = add_translation2(lang,'counterclockwise_compliance_slope','Correction anti-horaire','Intervalle de correction dans le sens anti-horaire');
...
lang = add_translation1(lang,'usb2dynamixel_title','Configuration de la communication avec le USB2Dynamixel (%s)');
...
lang = add_translation1(lang,'label_com_port','Port COM :');
lang = add_translation1(lang,'label_baud_rate','Bits par seconde :');
lang = add_translation1(lang,'label_auto_detect','Auto-détection des noeuds');
lang = add_translation1(lang,'label_auto_detect_progress','Annuler l''auto-détection (%d of %d, %d trouvé)');
lang = add_translation1(lang,'label_new_node','Insérer un nouveau noeud');
lang = add_translation1(lang,'label_del_node','Supprimer le noeud sélectionné');
lang = add_translation1(lang,'label_replace_existing_node','Remplacer le noeud existant ?');
lang = add_translation1(lang,'label_replace_existing_node2','Un noeud avec l''ID=%d existe déjà, voulez-vous le remplacer par un noeud %s ?');
lang = add_translation1(lang,'label_yes','oui');
lang = add_translation1(lang,'label_no','non');
lang = add_translation1(lang,'label_new_id','ID du nouveau noeud :');
lang = add_translation1(lang,'label_invalid_id','ID incorrect, un nombre entier entre 0 et 253 est attendu.');
