...
data.selected_text = uicontrol(f,'Style','text', ...
                                 'String',data.consts.labels.label_selected_joint, ...
                                 'HorizontalAlignment','left', ...
                                 'BackgroundColor','white', ...
                                 'Units','pixels', ...
...
data.ip_text = uicontrol(f,'Style','text', ...
                           'String',data.consts.labels.label_ip_address, ...
                           'HorizontalAlignment','left', ...
                           'Units','pixels', ...
...
data.port_text = uicontrol(f,'Style','text', ...
                             'String',data.consts.labels.label_port, ...
                             'HorizontalAlignment','left', ...
                             'Units','pixels', ...
...
data.protocol_text = uicontrol(f,'Style','text', ...
                                 'String',data.consts.labels.label_protocol, ...
                                 'HorizontalAlignment','left', ...
                                 'Units','pixels', ...
